...
<body class="antialiased">
    <div class="relative">
                    ...
                    <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                        ...
                        <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                            <div class="flex mt-2 flex-nowrap">
                                <img :class="{'border-4 border-serv-button': active === 1}" @click="changeThumbnail('<?= base_url()?>assets/img/service/service1.jpg',1)" src="<?= base_url()?>assets/img/service/service1.jpg" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                                <img :class="{'border-4 border-serv-button': active === 2}" @click="changeThumbnail('<?= base_url()?>assets/img/service/service2.jpg',2)" src="<?= base_url()?>assets/img/service/service2.jpg" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                                <img :class="{'border-4 border-serv-button': active === 3}" @click="changeThumbnail('<?= base_url()?>assets/img/service/service3.jpg',3)" src="<?= base_url()?>assets/img/service/service3.jpg" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                                <img :class="{'border-4 border-serv-button': active === 4}" @click="changeThumbnail('<?= base_url()?>assets/img/service/service4.jpg',4)" src="<?= base_url()?>assets/img/service/service4.jpg" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                                <img :class="{'border-4 border-serv-button': active === 5}" @click="changeThumbnail('<?= base_url()?>assets/img/service/service5.jpg',5)" src="<?= base_url()?>assets/img/service/service5.jpg" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                                <img :class="{'border-4 border-serv-button': active === 6}" @click="changeThumbnail('<?= base_url()?>assets/img/service/service6.jpg',6)" src="<?= base_url()?>assets/img/service/service6.jpg" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            </div>
                        </div>
                    </div>
                    <div class="content">
                        <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'description' }" id="tab_wrapper">
                            ...
                            <div x-show.transition.duration.500ms="tab === 'reviews'">
                                ...
                                <?php include 'navigasi/review.php'; ?>
                                <?php include 'navigasi/review.php'; ?>
                                <?php include 'navigasi/review.php'; ?>
        ...
        <!-- footer -->
        <?php include 'navigasi/footer.php' ?>
    </div>
