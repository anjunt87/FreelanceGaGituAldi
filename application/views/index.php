<!doctype html>
    ...
    <head>
        ...
        <link href="<?= base_url() ?>assets/dist/css/tailwindcss.css" rel="stylesheet">
        <link rel="stylesheet" href="<?= base_url() ?>assets/dist/css/style.css">
        <!-- Custom Upload Image -->
        <link rel="shortcut icon" href="<?= base_url('assets/img/customimage/'.$CustomFav['img']) ?>" src="<?= base_url()?>">
    ...
    <body class="antialiased">
        <div class="relative"> 
            ...
            <div class="hero-bg">
                ...
                <?php //isset($_GET['auth']) ? include 'navigasi/auth.php' : include 'navigasi/guest.php' ?>
                <!-- hero -->
                <div class="hero">
                    ...
                    <a class="bg-serv-button text-white text-lg font-semibold py-4 px-12 my-2 rounded-lg" href="<?= base_url('auth/signup')?>">
                        Get Started
                    </a>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/2 text-center lg:justify-start justify-center flex pr-0">
                ...
                src="<?= base_url() ?>assets/img/hero-image.png"alt="" /> -->
                <img class="bottom-0 lg:block lg:right-24 md:right-16 sm:right-8 right-8 w-75"
                src="<?= base_url('assets/img/customimage/'.$CustomImage['img']) ?>"alt="" />
            </div>
        </div>
        <div class="lg:mb-20 mb-10 flex sm:space-x-4 space-x-1">
            <div class="flex-1 flex items-center justify-center py-3 px-6">
                <img src="<?= base_url() ?>assets/img/brand-logo/netflix.svg" alt="">
            </div>
            <div class="flex-1 flex items-center justify-center py-3 px-6">
                <img src="<?= base_url() ?>assets/img/brand-logo/amazon.svg" alt="">
            </div>
            <div class="flex-1 flex items-center justify-center py-3 px-6">
                <img src="<?= base_url() ?>assets/img/brand-logo/uber.svg" alt="">
            </div>
            <div class="flex-1 flex items-center justify-center py-3 px-6">
                <img src="<?= base_url() ?>assets/img/brand-logo/grab.svg" alt="">
            </div>
            <div class="flex-1 flex items-center justify-center py-3 px-6">
                <img src="<?= base_url() ?>assets/img/brand-logo/google.svg" alt="">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="py-10 lg:py-24 flex lg:flex-row flex-col items-center cta-bg">
        ...
        <div class="w-full lg:w-1/2 text-center justify-center flex lg:mb-0 mb-12">
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" data-lity>
                <img id="hero" src="<?= base_url() ?>assets/img/video-placeholder.png" alt="" class="p-5" />
            </a>
        </div>
        <!-- Right Column -->
        <div class="lg:w-1/2 w-full flex flex-col lg:items-start items-center lg:text-left text-center">
            ...
            <a
            href="<?php echo base_url().'explore'?>"
